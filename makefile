...
install:
	...
	mkdir -p $(DESTDIR)/usr/share/pyhearts/data
	mkdir -p $(DESTDIR)/usr/share/pyhearts/data/img	
	...
	install -m644 img/*.gif $(DESTDIR)/usr/share/pyhearts/data/img/.
	install -m644 img/*.png $(DESTDIR)/usr/share/pyhearts/data/img/.
	install -m644 img/copying $(DESTDIR)/usr/share/pyhearts/data/img/.
